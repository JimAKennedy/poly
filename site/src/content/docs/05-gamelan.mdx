...
Where Balinese kotekan operates at the level of individual beats, Javanese gamelan organises time at a much larger scale through *colotomic structure*. The word comes from the Greek *kolon* (member) — it describes how a long temporal cycle is divided into nested, hierarchical parts by different instruments.
