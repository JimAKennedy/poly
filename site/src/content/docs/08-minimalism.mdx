...
{/* citation-tier-ok: Wikipedia cited for the phasing result itself. fr-cohn-1992 analyses Reich's phase-shifting music directly and is already in Further Reading. M006/B04 owns the upgrade. */}
...
Reich framed his own discovery as arriving at something West African and Indonesian musicians already knew, and that framing has carried into most writing about minimalism since. It is worth holding loosely: Agawu ([Agawu 2003](/appendix-references/#fr-agawu-2003)) questions who gets to describe African music and on whose terms, which is the prior question to whether the comparison holds. [Scherzinger 2010](/appendix-references/#fr-scherzinger-2010) takes up the comparison itself and is more critical of it than Reich was. West African ensembles stack fixed independent cycles; gamelan nests fixed cycles hierarchically. Neither drifts deliberately, and neither is doing what *Piano Phase* does — the resemblance is in the resulting texture, not in the technique.
...
{/* citation-tier-ok: a radio-station feature cited for the structure of In C. fr-potter-2000 (Four Musical Minimalists, CUP) covers Riley and is already in Further Reading. M006/B05 owns the upgrade. */}
