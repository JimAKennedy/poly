...
When two identical patterns move at slightly different rates, the interference between them generates far more complexity than either pattern contains alone ([Cohn 1992](/appendix-references/#fr-cohn-1992)). Steve Reich called it "music as a gradual process." Poly calls it the Drift parameter.
...
Terry Riley's *In C* (1964) takes a different approach: fifty-three short melodic phrases, performed by any number of players who move through them at their own pace ([Potter 2000](/appendix-references/#fr-potter-2000)). The texture at any moment depends on which phrases are active and how they overlap.
