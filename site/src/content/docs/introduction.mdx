...
Start with [Using Poly](/poly/guide-using-poly/) to install the plugin, set up MIDI routing, and learn the interface. That page covers everything you need to follow along with any chapter's examples.
...
The appendices provide reference material: [Architecture](/poly/appendix-architecture/) covers the engine internals and threading model, [Design Decisions](/poly/appendix-design-decisions/) documents the key trade-offs, and the parameter, preset, and Euclidean references serve as lookup tables.
