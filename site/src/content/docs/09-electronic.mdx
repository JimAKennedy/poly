...
The fundamental difference between techno and house is often reducible to one parameter: swing. Techno grooves are typically straight — quantised to the grid with no micro-timing offset. House music inherits its shuffle from disco and funk, displacing off-beat notes slightly late to create a looser, more human feel.
