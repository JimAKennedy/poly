...
{/* citation-tier-ok: E(5,16) as the bossa nova pattern is Toussaint's result (ref-1), already Tier A and cited elsewhere in this appendix. Same source and same missing M006 row as 10-brazilian.mdx. */}
