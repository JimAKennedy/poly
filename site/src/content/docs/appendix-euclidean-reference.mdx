...
| E(k,n) | Pattern | Grouping | Traditional Association | Chapter |
|--------|---------|----------|------------------------|---------|
| E(2,7) | `x . . x . . .` | 3+4 | Bendir accent (North Africa) | 1 |
...
<EuclideanDiagram steps={12} hits={7} rotation={2} />
...
<EuclideanDiagram steps={16} hits={5} rotation={10} />

E(5,16) is the bossa nova bass pattern — five onsets distributed as evenly as possible across sixteen pulses, producing the gap sequence 3-3-4-3-3.<sup>[1](/appendix-references/#ref-1)</sup> This is a genuine Euclidean rhythm. The Cuban son clave sits *close* to E(5,16) (differing only in the fifth hit's position: 12 vs 13) but is not itself Euclidean; its gap sequence 3-3-4-2-4 contains a 2 that E(k,n) cannot produce. See [Chapter 3 (Afro-Cuban)](/03-afro-cuban/) for the son-vs-rumba clave analysis and [Chapter 10 (Brazilian)](/10-brazilian/) for the bossa nova reading.

## Further Reading

Every table on this page is an application of Toussaint's result. [*The Geometry of Musical Rhythm*](/appendix-references/#fr-toussaint-2013) is the book-length treatment, and [Gotham's review](/appendix-references/#ref-44) is a short critical assessment of it.
