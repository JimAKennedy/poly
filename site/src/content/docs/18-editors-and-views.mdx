...
Euclidean distribution solves an optimization problem: given K hits and N steps, place the hits as evenly as possible. E(3,7) produces the inter-onset pattern [2+2+3] — three hits, seven steps, maximum evenness. This happens to match the rachenitsa grouping, which is why [Chapter 7 (Balkan)](/poly/07-balkan/) can demonstrate aksak patterns using Euclidean distribution. But the match is a fortunate coincidence, not a guarantee.
