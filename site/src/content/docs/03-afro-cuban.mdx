...
Those clave crossings deliberately break Rule 2 — a crossed part contradicts the matrix direction — before resolving back. That is a knowing break for tension, not the son idiom; see what breaks the Afro-Cuban idiom.
:::
