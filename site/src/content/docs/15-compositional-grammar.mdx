...
<PolyPreviewCard preset="Afro-House Phrases" caption="Composition arc — layered build from kick anchor through bell, ghost hat, and gated ornamental lanes" />

<PolyScreenshot src="/poly/screenshots/15-cubase-automation.png" caption="Cubase automation lane — Density macro swept from 0.2 to 0.8 over 16 bars for a textural crescendo" />
