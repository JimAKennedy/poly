...
Displays the plugin name **POLY** (blue), a **preset selector dropdown** in the center, and the version number (gray) on the right. Click the preset dropdown to access Init (All Lanes) and all 16 factory presets. Selecting any entry immediately loads all parameters.
