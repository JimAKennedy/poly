...
![Poly web UI showing the Afrobeat 12/8 preset in Desk mode — header bar, five lane columns with Euclidean circles and step cells, and the master panel with macro sliders and convergence display](/poly/screenshots/ui-overview.png)
