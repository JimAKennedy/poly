...
const CHAPTERS: ChapterSpec[] = [
  { preset: 'Polymetric Foundation', path: '/poly/01-foundations/', slug: 'polymetric-foundation' },
  { preset: 'Ewe Polymetric Ensemble', path: '/poly/02-sub-saharan-africa/', slug: 'ewe-polymetric-ensemble' },
  { preset: 'Manding Djembe', path: '/poly/02-sub-saharan-africa/', slug: 'manding-djembe' },
  { preset: 'Cuban Son Montuno', path: '/poly/03-afro-cuban/', slug: 'cuban-son-montuno' },
  { preset: 'Afrobeat Lagos', path: '/poly/04-afrobeat/', slug: 'afrobeat-lagos' },
  { preset: 'Balinese Kotekan', path: '/poly/05-gamelan/', slug: 'balinese-kotekan' },
  { preset: 'Javanese Colotomic', path: '/poly/05-gamelan/', slug: 'javanese-colotomic' },
  { preset: 'Tintal Groove', path: '/poly/06-indian-classical/', slug: 'tintal-groove' },
  { preset: 'Rupak Tal', path: '/poly/06-indian-classical/', slug: 'rupak-tal' },
  { preset: 'Rachenitsa 7/8', path: '/poly/07-balkan/', slug: 'rachenitsa-7-8' },
  { preset: 'Kopanitsa 11/8', path: '/poly/07-balkan/', slug: 'kopanitsa-11-8' },
  { preset: 'Reich Phase Process', path: '/poly/08-minimalism/', slug: 'reich-phase-process' },
  { preset: 'Riley Layered Entry', path: '/poly/08-minimalism/', slug: 'riley-layered-entry' },
  { preset: 'Nancarrow Tempi', path: '/poly/08-minimalism/', slug: 'nancarrow-tempi' },
  { preset: 'Minimal Techno', path: '/poly/09-electronic/', slug: 'minimal-techno' },
  { preset: 'Deep House', path: '/poly/09-electronic/', slug: 'deep-house' },
  { preset: 'Samba Batucada', path: '/poly/10-brazilian/', slug: 'samba-batucada' },
  { preset: 'Bossa Nova Trio', path: '/poly/10-brazilian/', slug: 'bossa-nova-trio' },
  { preset: 'Classic Funk', path: '/poly/11-funk-soul/', slug: 'classic-funk' },
  { preset: 'Neo-Soul Pocket', path: '/poly/11-funk-soul/', slug: 'neo-soul-pocket' },
  { preset: 'Jazz Bop Ride', path: '/poly/12-jazz/', slug: 'jazz-bop-ride' },
  { preset: 'Elvin Jones Cascade', path: '/poly/12-jazz/', slug: 'elvin-jones-cascade' },
  { preset: 'Jungle Break', path: '/poly/13-drum-and-bass/', slug: 'jungle-break' },
  { preset: 'Liquid Drum and Bass', path: '/poly/13-drum-and-bass/', slug: 'liquid-drum-and-bass' },
  { preset: 'Afro-Electronic Fusion', path: '/poly/14-synthesis/', slug: 'afro-electronic-fusion' },
  { preset: 'Balkan Funk', path: '/poly/14-synthesis/', slug: 'balkan-funk' },
  { preset: 'Compositional Arc', path: '/poly/15-compositional-grammar/', slug: 'compositional-arc' },
];
