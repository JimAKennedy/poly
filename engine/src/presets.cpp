...
const PresetInfo& getFactoryPresetInfo(int index) {
    static constexpr PresetInfo kInfos[kFactoryPresetCount] = {
        {"Four on the Floor", "Classic club groove with straight 8th hats and polymetric open hat", "House / Techno"},
        {"Polymetric Drift", "Prime-number cycles (3, 5, 7, 11) creating evolving phase patterns", "Foundational"},
        {"Sparse Pulse", "Minimal, spacious groove with wide spacing and gentle ghost notes", "Foundational"},
        {"Breakbeat", "Syncopated kick with punchy snare, fast hats and ghost toms", "Breaks / Drum & Bass"},
        {"Latin Feel", "Clave-inspired pattern with conga, shaker and cowbell ornaments", "Latin / Brazilian"},
        ...
        {"Bossa Nova", "Clave timeline with ginga micro-timing — surdo, tamborim, agogo and pandeiro",
         "Latin / Brazilian"},
        {"Carnatic Tala", "Adi tala [4+2+2] additive cells — mridangam, ghatam and kanjira", "Asian Traditions"},
        ...
        {"Ewe Polymetric Ensemble", "Gankogui bell timeline with support, responding, and interlocking lead drums",
         "African"},
        {"Manding Djembe", "Three-lane djembe ensemble — dunun, sangban, and lead sharing an 8-step cycle", "African"},
        {"Cuban Son Montuno", "Clave matrix with cascara, tumbao bass, conga, and shaker layers", "Latin / Brazilian"},
        {"Afrobeat Lagos",
         "Extended Afrobeat groove — bell timeline with staggered phrase gating on snare, shaker, and conga",
         "African"},
        {"Balinese Kotekan", "Polos and sangsih interlocking with jegogan bass and reyong accents", "Asian Traditions"},
        ...
        {"Tintal Groove", "Hindustani 16-beat cycle with sam, theka, dugun, and tigun layakari layers",
         "Asian Traditions"},
        {"Rupak Tal", "7-beat Hindustani cycle — sam marker, theka, and counter rhythm", "Asian Traditions"},
        ...
        {"Samba Batucada", "Full batucada ensemble — surdo, tamborim, agogo, repinique, and caixa",
         "Latin / Brazilian"},
        {"Bossa Nova Trio", "Intimate bossa — E(5,16) bass, ride cymbal, and ghost brush", "Latin / Brazilian"},
