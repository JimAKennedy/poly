...
- [ ] **T01: Design and implement Afro-House Phrases preset** `est:30min`
...
- [ ] **T02: Design and implement Reich Phasing preset** `est:30min`
...
- [ ] **T03: Design and implement Kotekan Interlock preset** `est:30min`
...
- [ ] **T04: Design and implement Pocket Groove preset** `est:30min`
...
- [ ] **T05: Update preset infrastructure and tests** `est:30min`
