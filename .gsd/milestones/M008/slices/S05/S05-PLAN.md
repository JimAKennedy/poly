...
- [ ] **T01: Design cross-rhythm view layout and rendering** `est:30min`
...
- [ ] **T02: Implement cross-rhythm view (VSTGUI CView)** `est:1.5h`
...
- [ ] **T03: Register view in uidesc and controller** `est:30min`
...
- [ ] **T04: Interaction smoke tests for cross-rhythm view** `est:30min`
