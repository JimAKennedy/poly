...
- [ ] **T01: Constraint data model** `est:1h`
...
- [ ] **T02: Anchor and backbeat constraints** `est:1.5h`
...
- [ ] **T04: Constraint serialization** `est:45m`
