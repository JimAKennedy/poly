...
- [ ] **T01: Add ownership-transfer annotation to controller.h createInstance** `est:2min`
...
- [ ] **T02: Add ownership-transfer annotation to controller.cpp LaneEditView** `est:2min`
...
- [ ] **T03: Add ownership-transfer annotation to processor.h createInstance** `est:2min`
