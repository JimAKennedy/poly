...
- [ ] **T01: Define and register EditController parameters** `est:60min`
...
- [ ] **T02: Implement ProcessContext to TransportContext bridge** `est:30min`
...
- [ ] **T03: Implement engine output to IEventList MIDI emission** `est:60min`
...
- [ ] **T04: Implement versioned state serialization** `est:45min`
...
- [ ] **T05: Add integration tests for plugin bridge** `est:40min`
