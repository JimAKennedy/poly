...
- [ ] **T01: Add swing and duration fields to LaneConfig** `est:15min`
...
- [ ] **T02: Implement swing offset in renderRange** `est:30min`
...
- [ ] **T03: Implement humanize timing jitter** `est:25min`
...
- [ ] **T04: Implement configurable note duration** `est:10min`
...
- [ ] **T05: Add swing and humanize tests plus golden updates** `est:25min`
