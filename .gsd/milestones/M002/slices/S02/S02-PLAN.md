...
- [x] **T01: Implement shape evaluation functions** `est:30min`
...
- [x] **T02: Implement PPQ-derived envelope phase calculation** `est:20min`
...
- [x] **T03: Apply envelope modulation in renderRange** `est:45min`
...
- [x] **T04: Add envelope unit and golden tests** `est:30min`
