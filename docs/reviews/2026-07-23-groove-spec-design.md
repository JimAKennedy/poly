...
> **Archived (2026-09-08)** — a dated design record, preserved unchanged. Written
> 2026-07-23 as groundwork for a natural-language groove-specification milestone
> that has not been scheduled. It carries a prior-art and licensing survey that
> nothing else in the repo records. Promote it to `class: gated` if the work
> becomes live; until then it is history, not a plan.
