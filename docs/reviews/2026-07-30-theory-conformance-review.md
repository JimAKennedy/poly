...
> **Archived (2026-09-08)** — a dated record, preserved unchanged. This review
> catalogued the discrepancies between the Theory Deep Dives and the earlier
> chapters, examples and factory presets. Its §4 is the authority
> `site/tests/theory-patch-conformance.test.mjs` encodes, which is why the
> document is tracked here rather than left on a branch.
