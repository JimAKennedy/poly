...
> **Archived (2026-09-08)** — a dated record, preserved unchanged. Superseded as
> the plan of record by [the theory-audit delivery ledger](plans/theory-audit/ledger.md).
> Kept because it carries the D1 decision (Bjorklund canonical) and the phase
> breakdown that decision came out of, neither of which the ledger restates.

Companion to [`2026-07-30-theory-conformance-review.md`](./2026-07-30-theory-conformance-review.md) (same
