...
> **Archived (2026-09-08)** — a dated record, preserved unchanged. A point-in-time
> assessment against `origin/main` @ `dbacc08`; its findings and counts describe
> the tree as it stood on 2026-08-22 and are not maintained.
