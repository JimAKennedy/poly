...
| P9 | M046 S06 (pending) | — | — | Loop-wrap treated as generic jump; wipes `captureBuffer_` every cycle. |
| P10 | M046 S07 (pending) | — | — | `kExportTrigger` never resets — dedupe-aware hosts drop the second click. |
