...
> **Archived (2026-09-08)** — a dated design record, preserved unchanged. Records
> the SLM-first-with-LLM-fall-through decision for the groove-spec compiler,
> companion to [the groove-spec design](./2026-07-23-groove-spec-design.md).
> Promote it to `class: gated` if the work becomes live.
