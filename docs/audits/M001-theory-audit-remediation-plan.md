...
| F07 | 2.1.2, §5.9 | Ch 2: Ewe ensemble music has been organised this way "for centuries." Unsourced; fieldwork documentation begins mid-20th century. | `P1` | `reframe` | `02-sub-saharan-africa.mdx` — the chapter opening paragraph | M001/S05 | Case S05-F07 in `site/tests/theory-audit-claims.test.mjs` forbids unhedged multi-century constructions (`for centuries`, `for hundreds of years`) in Ch 2 and requires the claim be bounded by the documentary record — fieldwork "from the mid-twentieth century" onward, with the greater depth attributed to the tradition's own understanding rather than asserted | `done` |
...
| S05 | Ch 2: bound the "centuries" claim to the documentary record; restore Toussaint's descriptive phrasing for E(7,12) and cite Toussaint (ref-1) rather than ref-4 for it. The E(7,12) superlative is corrected at both of its sites — the audit cited only Ch 2, but `appendix-euclidean-reference.mdx` repeats the sentence. | F07, F08 |
